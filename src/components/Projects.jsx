...
<div  className="w-full shadow-xl mx-4 my-7 transition hover:scale-105 bg-gradient-to-b from-[#1c116a] to-[#5e548e] rounded-xl sm:w-1/2 md:w-1/3 lg:w-1/4 px-2 mb-4" >
  <div className="overflow-hidden">
    ...
    <div className="px-3 pb-4">
      <h3 className="font-semibold mb-3 text-[1.2rem] text-white">{heading}</h3>
      <p className="text-gray-300">Al Sombola Contracting delivers exceptional results on diverse construction projects, from homes to commercial and industrial buildings.</p>
      <Link to="/Details" target="_blank" className="inline-block py-2 px-4 mt-4 rounded-md text-black bg-gray-100 hover:bg-red-200 transition-colors duration-300 shadow-md">
        Learn More
      </Link>
    </div>
  </div>
