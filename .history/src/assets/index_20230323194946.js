...
const completedProjects = [
    {img : comp1,
        name: null},
        {img : comp2,
        name:"Germany Pavilion Demolished"},
        {img : comp3,
        name:"Chiller Plant"},
        {img : comp4,
        name:"Car Parking Fabrication"},
        {img : comp5,
        name:null},
        {img : comp6,
        name:null},
        {img : comp7,
        name:"Finishing work Villas at Ajman Town"},
        {img : comp8,
        name:"Finishing work Villas at Ajman Town"},
        {img : comp9,
        name:"finishing work"},
        ...
        name:null},
        {img : comp11,
        name:"ADNOC Petrol Stations"},
        {img : comp12,
        name:"Fire Test Lab"},
        {img : comp13,
        name:"Olympics Building"},
        {img : comp14,
        name: "Finishing work @ReviraTower"},
        {img : comp15,
        name:" Finishing work @ReviraTower"},
        {img : comp16,
        name:"Finishing Work"},
        {img : comp17,
        name:"Offices Fitout Works"},
        {img : comp18,
        name: "Offices Fitout Works"},
        {img : comp19,
        name:"Road Works Pavements"},
        {img : comp20,
        name:null},
        
];
const incompleteProjects =[ {img  :incomp1,name :null },
{img  :incomp2,name : null},
{img  :incomp3,name : null},];

const interiorDesign = [{img:interior1,name:null},{img: interior2,name:null}];
export { email,hero, whatsapp,logo,completedProjects ,interiorDesign,incompleteProjects,registered};
