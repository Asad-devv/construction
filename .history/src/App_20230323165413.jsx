...
function App() {
  ...
  return (
    <div>
      ...
      {/* <Whatsapp/> */}
      <div className="w-[26vh] flex flex-row justify-center items-center mx-2 animate-bounce my-3 fixed py-2 gap-3  right-0 bottom-0 bg-gra-900 border rounded-full px-4 text-white ">
