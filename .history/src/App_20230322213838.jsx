...
function App() {
  ...
  return (
    <div>
      ...
      <ContactUs/>
      <Project2 projects={incompleteProjects} subtext="We are excited to showcase our ongoing projects, including a large-scale commercial development, a residential project, and a historic building renovation. Our team is dedicated to delivering exceptional results and we are pleased to share progress updates with our clients through pictures of these exciting projects. Check out our gallery to see our work in action.
