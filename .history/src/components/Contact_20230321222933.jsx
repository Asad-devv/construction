...
const ContactUs = () => {
  return (
    <div className="bg-[url('https://pcconstruction.com/app/uploads/2022/06/Contact_Header_03-scaled.jpg')] bg-no-repeat bg-cover bg-blend-lighten	 flex lg:flex-row-reverse sm:flex-col-reverse  bg-blue-900 justify-center items-center   h-[]]">
