      ...
      {images.map((image, i) => {
        return (
          ...
          <img
            ...
            key={i}
          />
               <div className="absolute opacity-60 inset-0 bg-gradient-to-b from-transparent to-blue-100 flex flex-col justify-end items-center">
                <h1 className="text-43xl font-bold">{image.tag}</h1>
              </div>
