      ...
      {images.map((image, i) => {
        return (
          ...
          <img
            src={image.img}
            alt="image"
            className="md:h-[85vh] lg:h-[85vh] h-auto sm:h-[55vh]  sm:object-fill opacity-10
          ...
          />
               <div className="absolute opacity-100 inset-0  flex flex-col justify-center items-center">
                <h1 className="lg:text-2xl sm:text-md text-white px-5 pb-10 font-bold">{image.tag}</h1>
                <button className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full'>Contact US now</button>
              </div>
