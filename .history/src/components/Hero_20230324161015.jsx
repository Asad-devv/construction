        ...
        return (
          ...
          />
               <div className="absolute opacity-100 inset-0  flex flex-col justify-center items-center z-10">
                {console.log(i)}
                <h1 className={`lg:text-[5rem] ${i==2 ? "self-start text-black lg:text-[3rem]" : "lg:text-[5rem]"} sm:text-md text-white px-10 pb-5 font-bold`}>{image.tag}</h1>
                <button className={`bg-blue-900 z-10 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full cursor-pointer`}><a id="contact" className='cursor-pointer'>{!(i==2) && "Contact US now"}</a></button>
              </div>
