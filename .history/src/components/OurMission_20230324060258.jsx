    ...
    <div className="flex flex-col items-center justify-center sm:px-10  px-10 md:px-10 lg:px-10  py-12 md:py-24">
      ...
      <div className="flex flex-col md:flex-row items-center md:justify-center lg:max-w-7xl md:space-x-12">
        <div className="flex-1 mb-8 md:mx-10 lg:mx-10 md:mb-0 sm:mx-10 md:mr-16">
          ...
          <h2 className="text-blue-700  font text-[2rem]">Vision</h2>
          <p className="text-[1rem] ">
            To be a reputable Building Contractor delivering beyond the
            expectation.
          </p>
          <h2 className="text-blue-700 font text-[2rem]  mt-2">Mission</h2>
          <p className="text-[1rem] ">
          ...
          <h2 className="text-blue-700 font text-[2rem]  mt-2">Value Statement</h2>
          <p className='text-[1rem]'>
