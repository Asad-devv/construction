...
const images = [{
  ...
  tag: "Established in 2013 as a Construction Business with the Mother Company Name M/s Haidar Abdulla Contracting Established in 1960, Over the years, the family business has undertaken many challenging projects of Construction, Building Trade and Project Management Services." ,
  img : hero
      ...
      {images.map((image, i) => {
        return (
          ...
          <img
            ...
            key={i}
          />
              <div className="absolute opacity-10 inset-0 bg-gradient-to-b from-transparent to-blue-200 flex flex-col justify-center items-center">
                
              </div>
              <div className='-pb-[20rem] relative inset-0 flex justify-center'>   <h1 className="text-4xl text-black z-10">{image.tag}</h1></div>
