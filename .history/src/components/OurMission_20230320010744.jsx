...
<div className="flex flex-col items-center justify-center bg-gray-100 py-12 md:py-24">
                ...
                <div className="flex flex-col md:flex-row items-center md:justify-center lg:max-w-7xl md:space-x-12">
                    ...
                    <div className="flex-1">
                        <img src="https://www.westend61.de/images/0000767413pw/construction-worker-talking-to-man-and-woman-on-a-construction-site-ZEF12466.jpg" alt="Mission" className="w-full rounded-md shadow object-cover" />
                    </div>
                </div>
            </div>
