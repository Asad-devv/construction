...
const services = [
  ...
  {
    heading: "Service 2",
    text: "Nullam vitae lectus askjanljksnajdk ajsnldaj nec magna tristique maximus eu vel eros.",
  },
  {
    heading: "Service 3",
        ...
        <div className="flex flex-wrap justify-center">
          {services.map((service, index) => {
            return (
              <div
                key={index}
                className="max-w-sm cursor-default my-10 hover:scale-110 transition max-h-lg bg-[#494a80] rounded-xl overflow-hidden shadow-lg m-4"
              >
