...
const ContactUs = () => {
  return (
    <div id="#contact" className=" bg-[url('https://www.westend61.de/images/0001363515pw/construction-workers-working-at-site-EYF04597.jpg')] bg-no-repeat bg-cover bg-center bg-blend-soft-light	md:flex-row-reverse flex lg:flex-row-reverse  sm:flex-col-reverse    mt-20 pb-20 bg-blue-900 justify-center mix-blend-multiply items-center pt-20  h-auto">
