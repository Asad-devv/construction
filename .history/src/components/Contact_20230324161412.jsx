        ...
        <div className="h-full flex flex-col items-center justify-center text-white">
          ...
          <form className="flex flex-col w-full max-w-md">
            ...
            <input
              id="name"
              type="text"
              className="bg-gray-200 rounded-s mb-4 py-2 px-1"
            />
            ...
            <button className="bg-blue-500 text-white font-bold py-2 px-1 rounded-s hover:bg-green-700 transition-colors duration-300">
              Submit
            </button>
          </form>
        </div>
