      ...
      {images.map((image, i) => {
        return (
          ...
          <img
            ...
            key={i}
          />
              <div className="absolute opacity-0 inset-0 bg-gradient-to-b from-transparent to-blue-300 flex flex-col justify-center items-center">
                <h1 className="text-4xl text-">find the best projects out there</h1>
              </div>
          </div>
        );
      })}
