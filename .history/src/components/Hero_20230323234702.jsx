      ...
      {images.map((image, i) => {
        return (
          ...
          <img
            ...
            key={i}
          />
               <div className="absolute opacity-100 inset-0 bg-gradient-to-b from-transparent to-blaue-100 flex flex-col justify-end items-center">
                <h1 className="lg:text-2xl sm:text-md font-bold">{image.tag}</h1>
              </div>
