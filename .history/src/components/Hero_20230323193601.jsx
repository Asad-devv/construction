...
const images = [{
  ...
  tag:"",
  img :"https://i.pinimg.com/564x/2d/8b/a5/2d8ba56af0950401fe3e332195eba9a1.jpg"
...
const Hero = () => {
  ...
  return (
    ...
    >
      {images.map((image, i) => {
        return (
          <div className={`bg-url('[${image.img}]') h-[85vh]`}>
          {/* <img
            src={image.img}
            alt="image"
          ...
          />
              <div className="absolute opacity-10 inset-0 bg-gradient-to-b from-transparent to-blue-300 flex flex-col justify-center items-center">
                <h1 className="text-4xl text-white font-light opacity-90">find the best projects out there </h1>
                <h3></h3>
              </div>
              <div className='inset-0'>   <h1 className="text-4xl text-">find the best projects out there</h1></div> */}
          </div>
        );
      })}
