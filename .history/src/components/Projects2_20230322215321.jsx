...
const Card = ({ imageUrl, heading }) => {
  return (
    <div className="w-full shadow-xl  transition hover:scale-105  sm:w-1/2 md:w-1/3 px-2 mb-4">
      <div className="bg-gray-200  rounded-lg overflow-hidden shadow-inner">
        <img
          ...
          return (
            <div className="relative">
              <img
                ...
                key={i}
              />
              <div className="absolute opacity-60 inset-0 bg-gradient-to-b from-blue-100 to-blue-100 flex flex-col justify-center items-center">
