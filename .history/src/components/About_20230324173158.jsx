      ...
      <div className="flex flex-col md:flex-row-reverse items-center md:justify-center lg:max-w-7xl md:space-x-12">
        <div className="flex-1 mb-8 md:mx-10 lg:mx-10 md:mb-0 sm:mx-10 md:mr-16">
          <p className="text-[1rem] ">
            ...
            projects of Construction,<br/> Building Trade and Project Management
            ...
            Villas, medium size buildings,<br/> factories and Ware house projects
            ...
            planning and execution of any type of construction project.<br/> Our
            ...
            Services. <br/>Our Emphasis on Clear Communication and follow-up
