      ...
      {images.map((image, i) => {
        return (
          ...
          <img
            src={image.img}
            alt="image"
            className="h-[85vh]  sm:object-contain
             w-full  bg-blend-darken	 lg:object-cover"
            key={i}
          />
              ...
              <div className=' relative inset-0 flex justify-center'>   <h1 className="lg:text-3xl md:text-2xl sm:text-4xl text-black z-10">{image.tag}</h1></div>
