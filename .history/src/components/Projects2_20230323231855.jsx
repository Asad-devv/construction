...
const Card = ({ imageUrl, heading }) => {
  return (
    <div className="w-full shadow-xl mx-4 my-7 transition hover:scale-105  sm:w-1/2 md:w-1/4 lg:w-1/3  px-2 mb-4">
...
const App = ({ projects, heading, subtext }) => {
  ...
  return (
    <div className="mt-20 flex flex-col justify-center">
      ...
      <div className="flex mt-10 lg:px-5 md:px-5 sm:px-10 flex-wrap">
