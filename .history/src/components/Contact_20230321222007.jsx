...
const ContactUs = () => {
  return (
    <div className="flex lg:flex-row-reverse sm:flex-col-reverse  bg-blue-900 justify-center items-center   h-screen">
      ...
      <div  className="bg-[url('https://www.bls.gov/spotlight/2022/the-construction-industry-labor-force-2003-to-2020/images/cover-image.jpg')] w-1/2 gap-4 bg-gray-2a00 flex flex-row items-center justify-center">
