...
const Services = () => {
  return (
    <div>
      <div className="text-white flex flex-col justify-centear  bg-[#252562] items-acenter items-center justify-center   py-20 md:py-">
        ...
        <div className="flex flex-wrap justify-center">
          {services.map((service, index) => {
            return (
              <div
                key={index}
                className="max-w-sm cursor-default my-5 hover:scale-110 transition max-h-lg bg-[#494a80] rounded-xl overflow-hidden shadow-lg m-4"
              >
