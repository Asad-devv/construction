        ...
        return (
          ...
          <img
            ...
            className="h-[85vh]  sm:object-contain
             w-full  bg-blend-darken	 object-fill"
            key={i}
          />
              ...
              <div className=' relative inset-0 flex justify-center'>   <h1 className="lg:text-4xl md:text-2xl sm:text-4xl text-black z-10">{image.tag}</h1></div>
