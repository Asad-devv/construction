  ...
  return (
    <div>
      ...
      {services.map((service, index) => {
        return(      
             <div key={index} className="max-w-md  max-h-lg bg-gray-800 rounded overflow-hidden shadow-lg m-4">
                <div>
                    <h1 className="text-[4rem]">{index}</h1>
                </div>
        <div className="px-8 py-6 h-64 flex flex-col justify-center items-center">
          <div className="font-bold text-2xl mb-4">{service.heading}</div>
