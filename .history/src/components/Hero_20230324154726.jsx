...
const images = [{
  tag:"Transforming spaces and building <br/> the future with expertise and innovation.",
      ...
      {images.map((image, i) => {
        return (
          ...
          <img
            ...
            key={i}
          />
               <div className="absolute opacity-100 inset-0  flex flex-col justify-center items-center">
                <h1 className="lg:text-4xl sm:text-md text-white px-5 pb-10 font-bold">{image.tag}</h1>
                <button className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full cursor-pointer'><a id="contact" className='cursor-pointer'>Contact US now</a></button>
              </div>
