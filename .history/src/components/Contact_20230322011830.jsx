...
const ContactUs = () => {
  return (
    <div className="bg-[url('https://www.westend61.de/images/0001363515pw/construction-workers-working-at-site-EYF04597.jpg')] bg-no-repeat bg-cover bg-center bg-blend-soft-light	 flex lg:flex-row-reverse sm:flex-col-reverse  flex-wrap mt-20 pb-20 bg-blue-900 justify-center mix-blend-multiply items-center pt-20  h-auto">
      {/* <h1>Contact US Now to build your dream project</h1> */}
      <div
        className="bg-contain  w-1/2a"
       
      >
        <div className="h-full w-[50%] flex flex-col items-center justify-center text-white">
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <div className=" mx-1a0 w-1/2 gap-4 bg-gray-2a00 flex flex-wrap flex-row items-center  justify-center">
          <div className="w-[15vh]  mt-8">
            <CircularProgressbar
              value={75}
              text={`${75}%`}
              strokeWidth={5}
            ...
            />
            <p className="text-center text-[1.1rem] text-white mt-2">
              Completed Projects
            </p>
          </div>
