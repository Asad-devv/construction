...
const ContactUs = () => {
  return (
    <div className="bg-[url('https://www.westend61.de/images/0001363515pw/construction-workers-working-at-site-EYF04597.jpg')] bg-no-repeat bg-cover bg-center bg-blend-soft-light	maix-blend-multiply z-10">
      <div className=" bg-blend-soft-light flex lg:flex-row-reverse sm:flex-col-reverse   justify-center  items-center   h-[80vh]">
          ...
          <div className="h-full flex flex-col items-center justify-center text-white">
            ...
            <form className="flex flex-col w-full max-w-md">
              ...
              <input
                id="email"
                type="email"
                className="bg-gray-200 text-black rounded-lg mb-4 py-2 px-4"
              />
