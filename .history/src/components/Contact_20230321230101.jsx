...
const ContactUs = () => {
  return (
    <div className="bg-[url('https://www.westend61.de/images/0001363515pw/construction-workers-working-at-site-EYF04597.jpg')] bg-no-repeat bg-cover bg-center bg-blend-soft-light	">
      <div className=" flex lg:flex-row-reverse sm:flex-col-reverse  bg-blue-900 justify-center mix-blend-multiply items-center   h-[80vh]">
