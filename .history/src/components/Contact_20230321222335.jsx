...
const ContactUs = () => {
  return (
    <div className="bg-[url('https://www.bls.gov/spotlight/2022/the-construction-industry-labor-force-2003-to-2020/images/cover-image.jpg')] bg-no-repeat bg-cover bg-gradient-to-r from-cyan-100 to-blue-100 flex lg:flex-row-reverse sm:flex-col-reverse  bg-blue-900 justify-center items-center   h-screen">
