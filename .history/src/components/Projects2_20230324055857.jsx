...
const Card = ({ imageUrl, heading }) => {
  return (
    <div className="w-full shadow-xl mx-4 my-7 transition hover:scale-105  sm:w-1/2 md:w-1/3 lg:w-1/4  px-2 mb-4">
      <div className="bg-gray-200  rounded-lg overflow-hidden shadow-md">
        ...
        />
        <div className="p-4">
          <h3 className="font-semibold text-xl mb-2">{heading}</h3>
        </div>
      </div>
    </div>
  );
...
const App = ({ projects, heading, subtext }) => {
  ...
  return (
    <div id={heading} className="mt-20 flex flex-col justify-center">
          ...
          return (
            <div className="mx-10 relative">
              <img
                src={project.img}
                alt="image"
                className="h-[85vh] md:h-[85vh] lg:h-[85vh] h-auto sm:h-[55vh]  sm:object-fill w-full  bg-blend-darken	 object-fill"
                key={i}
              />
              <div className="absolute opacity-60 inset-0 bg-gradient-to-b from-transparent to-blue-100 flex flex-col justify-center items-center">
