        ...
        return (
          ...
          />
               <div className="absolute opacity-100 inset-0  flex flex-col justify-center items-center">
                ...
                <button className='bg-blue-900 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full cursor-pointer'><a id="contact" className='cursor-pointer'>Contact US now</a></button>
              </div>
