        ...
        return (
          ...
          />
              <div className="absolute opacity-10 inset-0 bg-gradient-to-b from-transparent to-blue-300 flex flex-col justify-center items-center">
                <h1 className="text-4xl text-white font-light opacity-90">{image.tag} </h1>
                
              </div>
              <div className='pb-20 inset-0 flex justify-center'>   <h1 className="text-4xl text-">{image.tag}</h1></div>
          </div>
        );
      })}
