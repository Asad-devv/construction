...
const ContactUs = () => {
  return (
    <div className="bg-[url('https://www.gocanvas.com/content/wp-content/uploads/sites/3/2021/05/shutterstock_1105130297.jpg')] bg-no-repeat bg-cover bg-blend-lighten	 flex lg:flex-row-reverse sm:flex-col-reverse  bg-blue-900 justify-center items-center   h-[80vh]">
