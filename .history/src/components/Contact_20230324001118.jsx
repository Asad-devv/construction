...
const ContactUs = () => {
  return (
    <div className="bg-[url('https://www.westend61.de/images/0001363515pw/construction-workers-working-at-site-EYF04597.jpg')] bg-no-repeat bg-cover bg-center bg-blend-soft-light	md:flex-row-reverse flex lg:flex-row-reverse  sm:flex-col-reverse  sm:flex-col  mt-20 pb-20 bg-blue-900 justify-center mix-blend-multiply items-center pt-20  h-auto">
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="flex flex-row gap-7 text-[1.4rem] flex-awrap justify-center items-center mt-10 text-gray-300  ">
