...
const ContactUs = () => {
  return (
    <div className="bg-[url('https://www.westend61.de/images/0001363515pw/construction-workers-working-at-site-EYF04597.jpg')] bg-no-repeat bg-cover bg-center bg-blend-soft-light	 flex lg:flex-row-reverse sm:flex-col-reverse  flex-wrap mt-20 bg-blue-900 justify-center mix-blend-multiply items-center pt  h-auto">
