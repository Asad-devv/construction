    ...
    <div className="flex flex-col items-center justify-center bg-gray-100 py-12 md:py-24">
      ...
      <div className="flex flex-col md:flex-row items-center md:justify-center lg:max-w-7xl md:space-x-12">
        <div className="flex-1 mb-8 md:mb-0 md:mr-16">
          ...
          <h2 className="text-blue-700 text-[]">Vision</h2>
          <p className="text-[1rem]">
            To be a reputable Building Contractor delivering beyond the
            expectation.
          </p>
          <h2 className="text-blue-700 text-[]  mt-2">Mission</h2>
          <p className="text-[1rem]">
          ...
          <h2 className="text-blue-700 text-[]  mt-2">Value Statement</h2>
          <p className='text-[1rem]'>
        ...
        <div className="flex-1 h-[70vh] ">
          <img
            ...
            alt="Mission"
            className="w-full rounded-md shadow-lg h-[70vh]  object-cover"
          />
        </div>
      </div>
    </div>
