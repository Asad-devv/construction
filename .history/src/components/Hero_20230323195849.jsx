...
const images = [{
  ...
  tag:"Registered Business with Different Organizations" ,
  img : registered
      ...
      {images.map((image, i) => {
        return (
          ...
          <img
            ...
            key={i}
          />
              <div className=" opacity-10 inset-0 bg-gradient-to-b from-transparent to-blue-300 flex flex-col justify-center items-center">
