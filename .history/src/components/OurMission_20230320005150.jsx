...
const OurMission = () => {
  return (
    ...
    <div classNameName="w-[50vh] h-[50vh]">
      <img className="object-cover w-[50vh] h-[50vh] object-center rounded-lg shadow-md" src="https://www.betterteam.com/images/construction-worker-job-description-3481x2535-20201117.jpeg?crop=4:3,smart&width=1200&dpr=2" alt="Mission Image"/>
    </div>
  </div>
