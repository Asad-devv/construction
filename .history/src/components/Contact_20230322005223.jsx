...
const ContactUs = () => {
  return (
    ...
    <div className="bg-[url('https://www.westend61.de/images/0001363515pw/construction-workers-working-at-site-EYF04597.jpg')] bg-no-repeat bg-cover bg-center bg-blend-soft-light	 flex lg:flex-row-reverse sm:flex-col-reverse  bg-blue-900 justify-center mix-blend-multiply items-center   h-[80vh]">
      ...
      <div className="bg-contain w-1/2" style={{ backgroundImage: `url('/background.jpg')` }}>
...
<div className="flex flex-col justify-center items-center">
    <div className="flex flex-row justify-center items-center"><h1 className="text-[2.5rem] text-white">
         Build your dream project with us</h1></div>
      <div  className=" mx-10 w-1/2 gap-4 bg-gray-2a00 flex flex-row items-center justify-center">
        ...
        <div className="w-50 mt-8">
          ...
          />
          <p className="text-center text-[1.5rem] text-white mt-2">Completed Projects</p>
        </div>
        ...
        <div className="w-50 mt-8">
          ...
          />
          <p className="text-center text-[1.5rem] text-white">Ongoing Projects</p>
        </div>
        ...
        <div className="w-50 mt-8">
          ...
          />
          <p className="text-center text-[1.5rem]  text-white">Satisfied Clients</p>
        </div>
        
      </div>
      <div className="flex">
        
      <a className="text-lg"><i className="text-lg fab fa-whatsapp "> : </i>+971505894120 </a>
        <i class="fa-solid fa-phone"></i><p>EMAIL:<a href=""></a></p>
        +971 4 3889814 
        <a className="text-lg"><i className=" fa fa-phone"> : </i>+971 4 3889814  </a>
        <p><i class="fa fa-phone" aria-hidden="true"></i>+971 4 3889814   </p>
        <p><i class="fab  fa-whatsapp" aria-hidden="true"></i>+971505894120   </p>
  
        <p><i class="fa fa-whatsapp" aria-hidden="true"></i>+971505894120   </p>
