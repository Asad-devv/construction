...
function App() {
  ...
  return (
    <div>
      ...
      {/* <Whatsapp/> */}
      <div className="w-[26vh] flex flex-row justify-center items-center mx-8 animate-bounce my-3 fixed  right-0 bottom-0 bg-blue-900 border rounded-full px- text-white ">
